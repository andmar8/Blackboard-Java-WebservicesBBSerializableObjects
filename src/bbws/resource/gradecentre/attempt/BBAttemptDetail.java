 ...
 */
package bbws.resource.gradecentre.attempt;
...
//                //9.1.40071.3 on
//                catch(Exception e){this.attemptedDate = getDateTimeFromCalendar(a.getAttemptDate());}//User version 8 call
...
//                //9.1.40071.3 on
//                this.feedBackToUser = a.getFeedBackToUser().getFormattedText();
//                this.feedBackToUserHidden = a.isFeedbackToUserHidden();
//                this.grade = a.getGrade();
//                this.gradeId = a.getGradeId().getExternalString();
//                //9.1.40071.3 on
//                this.instructorNotes = a.getInstructorNotes().getFormattedText();
